...
describe('Questionnaire template generator', () => {
                            ...
                            ANSWER: [
                                {
                                    ...
                                    cond: [
                                        '==',
                                        '$.answers.p-applicant-are-you-a-british-citizen.q-applicant-are-you-a-british-citizen.value',
                                        'true'
                                    ]
                                },
                                {
                            ...
                            ANSWER: [
                                {
                                    ...
                                    cond: [
                                        '==',
                                        '$.answers.p-applicant-over-18.q-are-you-18-or-over.value',
                                        'true'
                                    ]
                                },
                                {
                            ...
                            ANSWER: [
                                {
                                    ...
                                    cond: [
                                        '==',
                                        '$.answers.p--who-is-applying.q-who-are-you-applying-for.value',
                                        'myself'
                                    ]
                                },
                                {
                            ...
                            ANSWER: [
                                {
                                    ...
                                    cond: [
                                        '==',
                                        '$.answers.p-applicant-are-you-a-victim.q-applicant-are-you-a-victim.value',
                                        'true'
                                    ]
                                },
                                {
                            ...
                            ANSWER: [
                                {
                                    ...
                                    cond: [
                                        'answeredLessThan',
                                        'p--attacker-name',
                                        '$.answers.p--number-of-attackers.q-number-of-attackers.value'
                                    ]
                                },
                                {
    ...
    describe('Given a path to a YAML file representing questionnaire routes', () => {
                            ...
                            ANSWER: [
                                {
                                    ...
                                    cond: [
                                        ...
                                        [
                                            '==',
                                            '$.answers.b.q-b.value',
                                            ['==', '$.answers.c.q-c.value', '$.answers.d.q-d.value']
                                        ]
                                    ]
                                },
                                {
        ...
        it('should throw if a section targets a section id that does not exist', () => {
            const options = {
                resolvedQuestionnaireMetadataFilePath: path.join(
                    __dirname,
                    '/fixtures/YAML/questionnaires/pre-resolved/section-id-does-not-exist.yml'
                ),
                sectionsDirPath: `${__dirname}/fixtures/YAML/sections/`
            };
        ...
        it('should throw if a route condition contains a question id that does not exist', () => {
            const options = {
                resolvedQuestionnaireMetadataFilePath: `${__dirname}/fixtures/YAML/questionnaires/pre-resolved/question-id-does-not-exist-test.yml`,
                sectionsDirPath: `${__dirname}/fixtures/YAML/sections/`
            };
            const rxExpectedError = errorMessageToRegExp(
        ...
        it('should throw if section JSON Schema file does not exist', () => {
            const options = {
                questionnaireMetadataFilePath: `${__dirname}/fixtures/YAML/questionnaires/pre-resolved/section-json-schema-file-does-not-exist-test.yml`,
                sectionsDirPath: `${__dirname}/fixtures/YAML/sections/`,
                routesDirPath: `${__dirname}/fixtures/YAML/routes/`
            };
            const expectedPath = path.join(
                options.sectionsDirPath,
                'no-json-schema-file-for-this-section.json'
            );
            const rxExpectedError = errorMessageToRegExp(
